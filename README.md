...
| [CleanPlates](CleanPlates/README.md) | Replaces nameplates, chat bubbles, and camera indicator plates with cleaner ones. | [Download](https://github.com/NotAKidoS/NAK_CVR_Mods/releases/download/r50/CleanPlates.dll) |
...
| [FuckWarmNightsVideoPlayer](FuckWarmNightsVideoPlayer/README.md) | A world made me mad with a 360p player texture, so I made that not world-authorable. | No Download |
