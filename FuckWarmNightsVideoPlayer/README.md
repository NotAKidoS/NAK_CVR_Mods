# FuckWarmNightsVideoPlayer

A world made me mad with a 360p player texture, so I made that not world-authorable.

Did you know, the video player still renders native res internally, and blits to the projection texture, introducing rescaling artifacts.

This mod fixes that. >:(

(mod is pending rename, probably)
